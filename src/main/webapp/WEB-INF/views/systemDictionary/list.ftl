                ...
                <div class="box-body table-responsive no-padding ">
                    <table class="table table-hover table-bordered">
                        ...
                        <#list pageInfo.list as systemDictionary>
                             <tr>
                                 ...
                                 <td>
                                     ...
                                     <a href="#" data-json='${systemDictionary.json}' class="btn btn-info btn-xs btn-input">
                                         <span class="glyphicon glyphicon-pencil"></span> 编辑
                                     </a>
                                     <a href="#" data-id="${systemDictionary.id}" class="btn btn-danger btn-xs btn-delete">
                        ...
                        <#--<c:forEach items="${pageInfo.list}" var="systemDictionary" varStatus="vs">
                            <tr>
                                <td>${vs.count}</td>
                                <td>${systemDictionary.name}</td>
                                <td>${systemDictionary.sn}</td>
                                <td>
                                    <a href="/systemDictionary/input.do?id=${systemDictionary.id}" class="btn btn-info btn-xs btn-input">
                                        <span class="glyphicon glyphicon-pencil"></span> 编辑
                                    </a>
                                    <a href="#" data-id="${systemDictionary.id}" class="btn btn-danger btn-xs btn-delete">
                                        <span class="glyphicon glyphicon-trash"></span> 删除
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">新增/编辑字典目录</h4>
            </div>
