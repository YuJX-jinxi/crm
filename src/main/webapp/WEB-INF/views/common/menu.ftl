        ...
        <ul class="sidebar-menu" data-widget="tree">
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li name="classInfo"><a href="/notice/list.do"><i class="fa fa-circle-o"></i> 公告管理</a></li>
                    <li name="classInfo"><a href="/courseorder/list.do"><i class="fa fa-circle-o"></i> 课程订单管理</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
